...
def lcs(str1, str2, m, n, track_m, track_n,count_track_pos):
    ...
    track_pos_n = []
    count_track_pos=0
    if m==0 or n==0 or len(track_pos_m) == len(str1) or  len(track_pos_m) == len(str2) or len(track_pos_n) == len(str1) or  len(track_pos_n) == len(str2): 
        # print("return 0")
        return 0 
        ...
        # print("track_n ",track_n)
        # print("str- ",str1[ m-1], str2[ n-1], m-1, n-1)
        return max(lcs(str1, str2, m-1, n,track_m-1,track_n,count_track_pos),lcs(str1, str2, m,n-1,track_m,track_n-1,count_track_pos))
